...
const TeamMemberCard: React.FC<{
    ...
    <div className="content-bubble text-center transition-all duration-300 hover:shadow-xl group animate-on-scroll" style={{ margin: 0, padding: 0 }}>
        ...
        <div className="p-4">
            ...
            {role && <p className="text-sm text-brand-text-secondary mt-1">{role}</p>}
        </div>
    </div>
    );
};
              ...
              <div className="container mx-auto px-6 max-w-7xl">
                  <div className="content-bubble text-center mb-12">
                      <div className="p-6 md:p-8">
                          ...
                          <p className="text-lg text-brand-text-secondary">Our dedicated dog care specialists who provide daily love and attention to our canine residents.</p>
                      </div>
                  </div>
              ...
              <div className="container mx-auto px-6 max-w-7xl">
                  <div className="content-bubble text-center mb-12">
                      <div className="p-6 md:p-8">
                          ...
                          <p className="text-lg text-brand-text-secondary">Our skilled horse care professionals who work with our equine friends on rehabilitation and daily care.</p>
                      </div>
                  </div>
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8 stagger-children">
