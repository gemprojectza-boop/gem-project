...
const HorseProfilePage: React.FC<HorseProfilePageProps> = ({ horseId, mediaContent, isEditMode, onMediaUpdate }) => {
    ...
    const ctaBlock = horse.status === 'Forever Sanctuary' ? (
        <>
            <h3 className="text-xl font-bold text-center text-brand-text-primary mb-4">Support {horse.name}'s Journey</h3>
         ...
         <>
            <h3 className="text-xl font-bold text-center text-brand-text-primary mb-4">Want to meet {horse.name}?</h3>
            ...
            <main className="container mx-auto p-4 md:p-8">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="content-bubble grid grid-cols-1">
                            ...
                            <div className="p-6 md:p-8">
                                <h2 className="text-3xl font-bold text-brand-primary mb-3">{horse.story.title}</h2>
                        ...
                        <div className="content-bubble">
                            <div className="p-6 md:p-8">
                                <h2 className="text-3xl font-bold text-brand-primary mb-3">{horse.personality.title}</h2>
                                <p className="text-brand-text-secondary leading-relaxed mb-6">{horse.personality.text}</p>

                                <h3 className="text-2xl font-bold text-brand-primary mb-3">{horse.specialTrait.title}</h3>
                        ...
                        <div className="content-bubble">
                            <div className="p-6 md:p-8">
                                <h2 className="text-3xl font-bold text-brand-primary mb-3">{horse.loveReason.title}</h2>
                    ...
                    <div className="lg:col-span-1 space-y-8">
                        ...
                        <div className="bg-brand-surface p-6 rounded-lg shadow-md border">
                            <h3 className="text-xl font-bold text-brand-primary mb-4">Ideal Home</h3>
                ...
                {/* Additional Media */}
                 <div className="my-12">
                     <h2 className="text-3xl font-bold text-brand-primary mb-6 text-center">More Photos & Videos of {horse.name}</h2>
