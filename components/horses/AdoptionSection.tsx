    ...
    <section id="adoption" className="py-16 md:py-20 bg-sanctuary-subtle-bg animate-on-scroll">
        <div className="container mx-auto px-6 max-w-6xl">
            ...
            <div className="content-bubble max-w-4xl mx-auto text-lg text-gray-700 space-y-4">
                ...
                <p>We are looking for homes where these horses will be treated with kindness, respect, and lifelong commitment. Their needs—physical, emotional, and social—must be fully met, and their well-being always put first.</p>
                <p>When you adopt from us, you're not just giving a horse a second chance—you’re becoming part of their story, a story that began in hardship and continues in hope.</p>
            </div>
            ...
            {adoptableHorses.length === 0 && (
                <div className="content-bubble text-center max-w-4xl mx-auto">
                    <p className="text-lg text-gray-700">We don't have any horses available for adoption at this moment. Please check back soon or meet our forever sanctuary residents!</p>
                </div>
            )}
        </div>
    </section>
