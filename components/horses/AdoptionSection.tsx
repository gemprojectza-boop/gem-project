    ...
    <section id="adoption" className="py-16 md:py-20 bg-sanctuary-subtle-bg animate-on-scroll" style={{textAlign: 'center'}}>
        <div className="container mx-auto px-6 max-w-6xl" style={{textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
            <div className="content-bubble text-center max-w-4xl mx-auto" style={{textAlign: 'center', margin: '0 auto'}}>
                <h2 className="text-3xl md:text-4xl font-bold" style={{textAlign: 'center', color: '#16a34a !important'}}>Meet Our Adoptable Horses</h2>
                <p className="mt-2 text-lg text-gray-600" style={{textAlign: 'center'}}>Could your pasture be their forever home?</p>
            </div>
            ...
            <div className="content-bubble max-w-4xl mx-auto text-lg text-gray-700 space-y-4 text-center" style={{textAlign: 'center', margin: '0 auto', display: 'block'}}>
                ...
                <p style={{textAlign: 'center'}}>We are looking for homes where these horses will be treated with kindness, respect, and lifelong commitment. Their needs—physical, emotional, and social—must be fully met, and their well-being always put first.</p>
                <p style={{textAlign: 'center'}}>When you adopt from us, you're not just giving a horse a second chance—you're becoming part of their story, a story that began in hardship and continues in hope.</p>
            </div>
            ...
            {adoptableHorses.length === 0 && (
                <div className="content-bubble text-center max-w-4xl mx-auto" style={{textAlign: 'center', margin: '0 auto'}}>
                    <p className="text-lg text-gray-700" style={{textAlign: 'center'}}>We don't have any horses available for adoption at this moment. Please check back soon or meet our forever sanctuary residents!</p>
                </div>
            )}
        </div>
    </section>
