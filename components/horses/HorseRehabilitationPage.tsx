        ...
        <div className="bg-brand-bg-main">
                ...
                <div className="container mx-auto px-6 max-w-5xl space-y-16">
                    ...
                    <div className="content-bubble">
                        <div className="p-6 md:p-8 space-y-10">
                            <div>
                                <h3 className="text-2xl font-bold text-brand-primary mb-4">Veterinary Assessment</h3>
                                <div className="text-lg text-brand-text-secondary space-y-4">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-brand-primary mb-4">Dentistry</h3>
                                <div className="text-lg text-brand-text-secondary space-y-4">
                             ...
                             <div>
                                <h3 className="text-2xl font-bold text-brand-primary mb-4">Physical Healing</h3>
                                <div className="text-lg text-brand-text-secondary space-y-4">
                             ...
                             <div>
                                <h3 className="text-2xl font-bold text-brand-primary mb-4">Body Work</h3>
                                <div className="text-lg text-brand-text-secondary space-y-4">
            ...
            <section className="py-20 bg-brand-primary">
                <div className="container mx-auto px-6 text-center text-white">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold mb-4">Be Part of the Healing</h2>
