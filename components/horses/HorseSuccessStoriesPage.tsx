...
const stories = [
    ...
    { 
        ...
        afterKeys: ['beyonce_success_after_1', 'beyonce_success_after_2'], 
    ...
    { 
        ...
        afterKeys: ['peekaboo_success_after_1', 'peekaboo_success_after_2', 'peekaboo_success_after_3', 'peekaboo_success_after_4', 'peekaboo_success_after_5', 'peekaboo_success_after_6'], 
    ...
    { 
        ...
        afterKeys: ['sashay_success_after_1', 'sashay_success_after_2', 'sashay_success_after_3'], 
