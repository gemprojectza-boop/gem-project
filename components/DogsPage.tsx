    ...
    <div className="bg-white">
      ...
      <ContentSection title="Our Vision">
       ...
       <ContentSection title="Why It Matters" className="bg-sanctuary-dark text-white" textClassName="text-gray-300" titleClassName="text-white">
        <p className="text-center">Many of our dogs arrived with fear in their eyes, scars on their bodies or no one to call their own. Some were simply unwanted. Here, that changes. They find hands that heal, hearts that see them and a place to call home even if that home is with us forever.</p>
        <p className="text-center">Some are adopted and begin new lives. Others stay here, deeply loved and never alone again.</p>
