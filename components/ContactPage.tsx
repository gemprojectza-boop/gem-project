...
const ContactInfoItem: React.FC<{ icon: React.ReactNode; title: string; children: React.ReactNode; }> = ({ icon, title, children }) => (
    <div className="flex items-start space-x-4">
        ...
        <div>
            ...
            <div className="text-brand-text-secondary text-sm text-center">{children}</div>
        </div>
    </div>
);
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="content-bubble">
                        <div className="p-6 md:p-8 space-y-6">
                            <ContactInfoItem icon={<MapPinIcon className="w-6 h-6"/>} title="Location">
                                <p className="text-center">Philadelphia, Atlantis, Western Cape, South Africa</p>
                            ...
                            <ContactInfoItem icon={<MailIcon className="w-6 h-6"/>} title="Email">
                                ...
                                <p className="text-center">For all general enquiries including adoption, sponsorship, donations, volunteering and Hands-On Care.</p>
                            </ContactInfoItem>
                             <ContactInfoItem icon={<PhoneIcon className="w-6 h-6"/>} title="Phone">
                                <p className="text-center">021 065 1691</p>
                                <p className="text-center">We are available Monday to Friday from 9am to 5pm.</p>
                            </ContactInfoItem>
                        </div>
                    </div>
                     <div className="content-bubble">
                        <div className="p-6 md:p-8">
                            ...
                            <p className="text-brand-text-secondary mb-4 text-center">See the daily lives you are changing by following us on social media.</p>
                ...
                <div className="content-bubble">
                    <div className="p-6 md:p-8">
                        ...
                        <p className="text-brand-text-secondary mb-6 text-center">Fill in the form below and we will get back to you as soon as possible.</p>
                        ...
                        {isSubmitted ? (
                            <div className="text-center bg-brand-accent/20 text-brand-accent-hover p-8 rounded-lg">
                                ...
                                <p className="text-center">Your message has been sent. We aim to respond within 1 to 2 working days.</p>
                            </div>
                        ) : (
        ...
        <div className="container mx-auto px-6 max-w-4xl">
             <div className="content-bubble">
                <div className="p-6 md:p-8 text-center">
                    ...
                    <p className="my-6 text-lg text-center">Every message opens the door to a kinder world. Whether you choose to adopt, sponsor or support in your own way, you are helping animals feel safe, seen and loved.</p>
