    ...
    return (
        <div className="border-b last:border-b-0 border-gray-200">
            <button
                ...
                className="w-full flex justify-between items-center text-center py-5 px-6 hover:bg-brand-primary/10 transition-colors"
            ...
            >
                <div className="overflow-hidden">
                    <div className="p-6 pt-0 text-brand-text-secondary space-y-4 text-base leading-relaxed text-center">
                        {children}
                    </div>
                </div>
            </div>
        ...
        <div className="container mx-auto px-6 max-w-4xl">
            <div className="content-bubble text-center">
                 <div className="p-6 md:p-8">
                    <p className="text-lg text-center">Whether you are thinking of adopting, sponsoring, volunteering, donating or just learning more, this page covers the questions we get asked most often. Still wondering about something? Reach out. We are happy to help.</p>
        ...
        <div className="container mx-auto px-6 max-w-4xl space-y-12">
          ...
          <div className="content-bubble" style={{margin:0, padding: 0}}>
            ...
            <AccordionItem question="What is your mission and vision?">
                 <p className="text-center">We envision a world where every dog and horse knows safety, comfort and belonging.</p>  
                 <p className="text-center">Our mission is to rescue, rehabilitate and rehome animals in need while also providing lifelong care to those who cannot be adopted. We build meaningful partnerships and create a culture of compassion through adoption, sanctuary and community engagement.</p>
            </AccordionItem>
            <AccordionItem question="How is a sanctuary different from a shelter?">
                <p className="text-center">Unlike traditional shelters, we commit to animals for life. While we do rehome many animals, others remain with us permanently due to age, medical needs or trauma. We are their forever home when no other is possible.</p>
            </AccordionItem>
             <AccordionItem question="What makes you different from other sanctuaries or rescues?">
                <p className="text-center">We provide both longterm sanctuary and a thoughtful adoption process. Every animal lives in a homelike setting. Dogs stay in familystyle units and enjoy daily walks, enrichment and outings. Horses roam open paddocks and receive consistent loving care.</p>
            </AccordionItem>
          </div>
          ...
          <div className="content-bubble" style={{margin:0, padding: 0}}>
            <h2 className="text-3xl font-bold text-brand-primary p-6 border-b">Our Work and Programmes</h2>
             <AccordionItem question="What kind of animals do you care for?">
                <p className="text-center">We care for dogs and horses of all breeds, ages and backgrounds including those with special medical or behavioural needs.</p>
            </AccordionItem>
            ...
            <AccordionItem question="Do you work with other organisations?">
                <p className="text-center">Yes. We support overburdened shelters by fostering animals in need of urgent placement. We also offer behavioural help for challenging cases and collaborate on shared outreach efforts.</p>
            </AccordionItem>
            <AccordionItem question="What is the Youth Apprenticeship Programme?">
                <p className="text-center">It is a structured initiative offering handson experience in animal care to local youth. Participants learn valuable life skills while building empathy and responsibility.</p>
            </AccordionItem>
            <AccordionItem question="What is the HandsOn Caregiver Programme?">
                 <p className="text-center">The HandsOn Caregiver Programme allows individuals to become partowners in the daily life of a sanctuary animal. Caregivers form deep bonds through regular visits, feeding, grooming and companionship. It is perfect for those who want meaningful connection without fulltime responsibility. Caregivers are honoured as part of each animal’s extended family.</p>
           ...
           <div className="content-bubble" style={{margin:0, padding: 0}}>
            <h2 className="text-3xl font-bold text-brand-primary p-6 border-b">Adoption</h2>
             <AccordionItem question="Can I adopt a dog or horse?">
                <p className="text-center">Yes. Adoption is central to our mission. We carefully match each animal with a suitable home. Every adoption is guided by the best interests of the animal and the adopter.</p>
            </AccordionItem>
             <AccordionItem question="What is the adoption process like?">
                <p className="text-center">After submitting an application, we conduct interviews and home checks to ensure the animal will be safe, loved and wellmatched. Some animals are available only for sponsorship.</p>
            </AccordionItem>
             <AccordionItem question="Can I meet the animals before adopting?">
                <p className="text-center">Yes. Visits can be arranged for adopters, sponsors and HandsOn Caregivers. We also share regular photos, videos and updates online.</p>
           ...
           <div className="content-bubble" style={{margin:0, padding: 0}}>
            <h2 className="text-3xl font-bold text-brand-primary p-6 border-b">Sponsorship</h2>
             <AccordionItem question="Can I sponsor a specific animal?">
                <p className="text-center">Yes. Sponsorship helps cover the cost of food, care and enrichment for one of our dogs or horses.</p>
            </AccordionItem>
             ...
             <AccordionItem question="What if I want to help but cannot adopt or sponsor?">
                <p className="text-center">You can still support us by donating, volunteering, sharing our work or joining a programme. Every bit helps.</p>
           ...
           <div className="content-bubble" style={{margin:0, padding: 0}}>
            <h2 className="text-3xl font-bold text-brand-primary p-6 border-b">Ways to Help</h2>
             ...
             <AccordionItem question="What do you need most?">
                <p className="text-center">Monetary donations, dog food, flea treatments, supplements, grooming supplies and cleaning products are always needed.</p>
             ...
             <AccordionItem question="Can I volunteer at the sanctuary?">
                <p className="text-center">Yes. Volunteers help with care, admin, outreach, fundraising and events.</p>
            </AccordionItem>
             <AccordionItem question="Can I help without visiting the sanctuary?">
                <p className="text-center">Yes. You can assist by donating, sharing our posts or helping with outreach and grant writing.</p>
            </AccordionItem>
             <AccordionItem question="How can I stay connected?">
                <p className="text-center">Follow us on social media and sign up for updates to see daily life at the sanctuary.</p>
            </AccordionItem>
          </div>
        ...
        <div className="container mx-auto px-6 max-w-4xl">
            <div className="content-bubble">
                <div className="p-6 md:p-8 text-center">
                    ...
                    <p className="my-6 text-lg text-center">We would love to hear from you. Whether you are ready to adopt, want to help or just want to learn more our team is here.</p>
