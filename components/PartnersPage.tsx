        ...
        <div className="relative container mx-auto px-6 text-center">
            <div className="max-w-3xl mx-auto">
                <div className="p-6 md:p-8">
                    ...
                    <p className="my-6 text-white text-center" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8), 1px 1px 2px rgba(0,0,0,0.6)'}}>If your organisation shares our commitment to compassionate, ethical animal care, we would love to connect. Whether you are a welfare group, a veterinary practice, or a business with a heart for animals, there are many ways we can work together.</p>
