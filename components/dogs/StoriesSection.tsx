        ...
        <div className="container mx-auto px-6 max-w-7xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
                <Story name="Ruby" mediaKey="stories_ruby" alt="A sad, scared-looking dog" {...props}>
                    ...
                    <p className="text-center">Ruby had likely gone her entire life without knowing kindness. She flinched at every sound and shied away from every human touch. At first, she would barely eat or move. We gave her a quiet space to settle with soft blankets and round-the-clock monitoring.</p>
                    <p className="text-center">Ruby was suffering from a severe skin condition, malnourishment, and a heavy infestation of worms, ticks and fleas. She also had undiagnosed arthritis and deep social anxiety after a lifetime of isolation.</p>
                    <p className="text-center">With dedicated veterinary care and slow, gentle rehabilitation, Ruby's health began to improve. As her physical strength returned, so did her personality. She started greeting caregivers with gentle tail wags and resting her head in our laps. Watching Ruby rediscover joy has been one of the most moving experiences at the sanctuary.</p>
                </Story>
                ...
                <Story name="Honey" mediaKey="stories_honey" alt="A resilient dog with one eye" {...props}>
                    ...
                    <p className="text-center">Honey came to us in a way we will never forget. She walked herself to the sanctuary gate and collapsed, as if knowing she needed help. The fact that she chose to come to us spoke volumes about her will to survive.</p>
                    <p className="text-center">She had recently lost sight in one eye, was dangerously underweight, covered in ticks, and suffering from a skin condition and open wounds. In the first days, we focused on stabilising her, treating her wounds, and offering gentle reassurance.</p>
                    <p className="text-center">Adapting to partial blindness has been difficult, but Honey continues to surprise us. Her physical health improved dramatically, and her emotional healing continues each day. She's developed strong bonds with a few of our long-term dogs and now walks confidently on familiar paths, slowly learning to trust the world again.</p>
                </Story>
                ...
                <Story name="Queenie" mediaKey="stories_queenie" alt="A mother dog and her puppies" {...props}>
                    ...
                    <p className="text-center">Queenie and her puppies were among the dogs left behind by the previous owner of the farm where our sanctuary now stands. At the time, Queenie was undernourished and doing her best to care for her pups with almost nothing. Her resilience and devotion were undeniable.</p>
                    <p className="text-center">From the very beginning, we knew we had to earn her trust. We gave her space, moved slowly, and ensured she felt secure. As food became regular and her pups grew stronger, Queenie began to soften.</p>
                    <p className="text-center">We treated her for mange and malnutrition. Today, Queenie is still with us, a gentle and affectionate soul. Her puppies have grown into healthy, confident young dogs, and two have already found loving forever homes. Queenie's journey from fierce protector to peaceful companion remains one of our most beautiful transformations.</p>
                </Story>
            </div>
