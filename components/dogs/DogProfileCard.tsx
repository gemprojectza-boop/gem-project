    ...
    return (
        ...
        >
            ...
            <div className="p-4 flex flex-col flex-grow">
                <h3 className="text-2xl font-bold text-brand-text-primary group-hover:text-brand-primary transition-colors">{dog.name}</h3>
                <p className="text-brand-text-secondary text-sm mb-2">{dog.petInfo.breed}</p>
                <p className="text-brand-text-secondary text-sm mb-4 flex-grow">{dog.idealHome}</p>
