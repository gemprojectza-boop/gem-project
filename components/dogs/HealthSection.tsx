...
const HealthChecklistItem: React.FC<{ icon: React.ReactNode, title: string, children: React.ReactNode }> = ({ icon, title, children }) => (
    <div className="content-bubble flex items-start space-x-4 h-full p-6">
...
const HealthSection: React.FC<SectionProps> = (props) => {
  return (
    <section id="health" className="py-16 md:py-20 bg-brand-bg-main">
        <div className="container mx-auto px-6 max-w-6xl">
            <div className="max-w-4xl mx-auto">
                <div className="content-bubble text-center">
                    <div className="p-6 md:p-8">
                        <PawIcon className="w-10 h-10 text-brand-secondary mx-auto mb-4" />
                        <h2 className="text-3xl md:text-4xl font-bold text-brand-secondary">Animal Health & Wellbeing</h2>
                         <p className="mt-2 text-lg text-gray-600">Caring for every part of every animal.</p>
                    </div>
                </div>
            ...
            <div className="content-bubble text-center mt-12">
              <div className="p-6 md:p-8">
                <PawIcon className="w-10 h-10 text-brand-secondary mx-auto mb-4" />
                <h2 className="text-3xl md:text-4xl font-bold text-brand-secondary">Our 7-Point Comprehensive Care Approach</h2>
              </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="content-bubble text-center mt-8 bg-brand-primary text-white">
                    <div className="p-6 md:p-8">
                        ...
                        <h2 className="text-3xl font-bold mb-4 text-brand-secondary">Help Us Heal More Dogs Like Louis</h2>
                        <div className="flex flex-wrap justify-center gap-4">
                            <CtaButton href="/donate" className="bg-brand-secondary text-white hover:bg-brand-secondary-hover">Donate for Medical Care</CtaButton>
                            <CtaButton href="/dogs/sponsorship" className="border border-white text-white hover:bg-brand-secondary hover:border-brand-secondary">Sponsor a Dog's Recovery</CtaButton>
                        </div>
                    </div>
                </div>
            </div>
