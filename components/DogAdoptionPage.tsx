...
const DogAdoptionPage: React.FC<DogAdoptionPageProps> = (props) => {
  ...
  return (
    <div className="bg-brand-bg-main dog-page-override">
        ...
        <div className="container mx-auto px-6 max-w-7xl">
            <div className="flex justify-center">
                <div className="content-bubble text-center max-w-4xl">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-brand-secondary">Meet Our Adoptable Dogs</h2>
      ...
      <ContentSection title="Your New Best Friend is Waiting" titleColorClass="text-brand-secondary">
      ...
      <ContentSection title="Our Adoption Process" className="bg-brand-bg-subtle" titleColorClass="text-brand-secondary">
       ...
       <ContentSection title="Why Adopt from Us?" titleColorClass="text-brand-secondary">
        ...
        <div className="mt-8">
            <h3 className="text-2xl font-bold text-brand-secondary mb-4">Benefits of Adopting from The Gem Project Sanctuary:</h3>
